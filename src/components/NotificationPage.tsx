      ...
      <div className="space-y-4">
        {notifications.map(n => (
          <div 
            ...
            className={`bg-white border p-6 flex items-center gap-6 cursor-pointer group transition-all rounded-[2.5rem] shadow-sm ${n.isRead ? 'opacity-60 grayscale border-slate-100' : 'border-emerald-500/20 bg-emerald-500/5 shadow-emerald-50'}`}
          >
